...
install: all
	...
	@mkdir -p $(DESTDIR)/$(PREFIX)/include/libink
	install src/*.h $(DESTDIR)/$(PREFIX)/include/libink/.

#
# Removing
#
remove:
	rm -rf $(DESTDIR)/$(PREFIX)/lib/libink.*
	rm -rf $(DESTDIR)/$(PREFIX)/include/libink*
